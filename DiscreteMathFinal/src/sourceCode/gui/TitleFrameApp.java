...
public class TitleFrameApp extends javax.swing.JFrame {
    ...
    private String[] algorithmNames = new String[]{"Bubble Sort","Insertion Sort","Linear Search","Binary Search","Greatest Common Divisor"};
    public static enum AlgChoice{
        BUBBLE_SORT,INSERTION_SORT,LINEAR_SEARCH,BINARY_SEARCH,GREATEST_COMMON_DIVISOR        
    }
    /**
    ...
    private void initComponents() {
        ...
        setTitle("Discrete Mathematics Final");
        setResizable(false);

        titleLbl.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        titleLbl.setText("Algorithm Implementations");
